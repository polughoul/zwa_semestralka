...
<body>
    ...
    <main>
        <form class="appointment_form" action="/script.php" method="get">
            ...
            <input class="appointment_input_form" type="text" id="fname" name="fname"><br><br>
            <label class="appointment_label_form" for="sname">Please enter your surname:</label>
            <input class="appointment_input_form" type="text" id="sname" name="sname"><br><br>
            <label class="appointment_label_form" for="pass">Please enter a number of your passport</label>
            <input class="appointment_input_form" type="text" id="pass" name="pass"><br><br>
            <label class="appointment_label_form" for="email">Please enter your e-mail</label>
            <input class="appointment_input_form" type="email" id="email" name="email"><br><br>
            <label class="appointment_label_form" for="tel">Please enter your phone number</label>
            <input class="appointment_input_form" type="tel" id="tel" name="tel"><br><br>
            <label class="appointment_label_form" for="pass">Please choose a date, time and doctor</label><br>
            <input class="appointment_input_form" type="date" id="date" name="date">
            <input class="appointment_input_form" type="time" id="time" name="datetime">
